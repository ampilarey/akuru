...
export default function Levels({ rows }) {
    const form = useForm({ name_en: '', name_dv: '', name_ar: '' });

    return (
        <AppShell title="Course levels">
            <div className="mb-4 flex justify-end">
                <a className="btn-secondary" href="/catalog/levels/export">Export CSV</a>
            </div>
            <form
                onSubmit={(e) => {
                    e.preventDefault();
                    form.post('/catalog/levels', { preserveScroll: true });
                }}
            ...
            >
                ...
                <button type="submit" className="btn-primary" disabled={form.processing}>Save level</button>
            </form>
