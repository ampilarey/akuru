...
<body class="min-h-screen bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <div style="background:#ec4899;color:#ffffff;text-align:center;padding:10px 16px;font-weight:700;font-size:14px;letter-spacing:.02em;">
        🚀 Auto-deploy is live — this pink banner was deployed automatically via GitHub Actions.
    </div>
    <x-public.nav />
    ...
    <style>
        ...
        .viber-float { animation: viber-pulse 2.5s ease-out infinite; }
    </style>
    <a href="viber://chat?number=%2B{{ $siteSettings['viber'] ?? '9607972434' }}" target="_blank" rel="noopener"
       class="viber-float hidden sm:flex fixed bottom-6 right-6 z-40 w-16 h-16 bg-purple-600 hover:bg-purple-700 text-white rounded-full items-center justify-center shadow-xl transition-all hover:scale-110"
       aria-label="Contact us on Viber"
       title="Chat with us on Viber">
        <svg class="w-9 h-9" fill="currentColor" viewBox="0 0 24 24"><path d="M11.993 0h-.036C5.5 0 .527 4.972.527 11.473c0 3.107 1.2 5.943 3.17 8.053V23l2.953-1.628a11.03 11.03 0 005.343 1.364h.036c6.457 0 11.43-4.972 11.43-11.472C23.459 4.813 18.487 0 11.993 0zm1.164 15.516s-.27-.031-.406-.186l-.92-.999c-.283.09-.576.135-.872.135-1.637 0-2.97-1.25-2.97-2.793 0-1.543 1.333-2.793 2.97-2.793s2.97 1.25 2.97 2.793c0 .64-.226 1.228-.606 1.7l.644.7c.15.161.176.396.056.583a.44.44 0 01-.366.193l-.5-.333zm3.454 1.04c-.18.504-.885 1.02-1.46 1.141-.383.08-.877.143-2.55-.548-2.143-.882-3.523-3.05-3.63-3.192-.107-.14-.873-1.162-.873-2.217s.55-1.553.76-1.77a.8.8 0 01.576-.27c.143 0 .286.003.41.01.132.007.309-.05.483.37.18.43.611 1.493.663 1.601.053.108.088.235.017.376-.07.14-.105.226-.211.347-.107.12-.225.269-.32.361-.107.103-.219.215-.094.421.125.207.557.92 1.196 1.49.82.73 1.513.956 1.725 1.063.212.107.334.09.457-.054.125-.143.536-.626.68-.84.143-.212.285-.177.481-.107.197.07 1.253.592 1.467.7.214.107.356.16.408.25.053.09.053.52-.127 1.024zm-6.01-5.12a1.49 1.49 0 110 2.98 1.49 1.49 0 010-2.98z"/></svg>
    </a>
