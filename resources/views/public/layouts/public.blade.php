...
<body class="min-h-screen bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 sm:hidden bg-white border-t border-gray-200 shadow-lg safe-area-bottom">
        <div class="grid grid-cols-5 divide-x divide-gray-100">
            ...
            <a href="https://wa.me/9607972434" target="_blank" rel="noopener"
    ...
    <a href="https://wa.me/9607972434" target="_blank" rel="noopener" class="hidden sm:flex fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full items-center justify-center shadow-lg transition-all hover:scale-110" aria-label="Contact us on WhatsApp">
