                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-brandGray-200 rounded-lg p-6">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="viber://forward?text={{ urlencode($event->title . ' ' . request()->url()) }}" target="_blank" rel="noopener" class="inline-flex items-center px-3 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 text-sm">Viber</a>
                        </div>
                    </div>
