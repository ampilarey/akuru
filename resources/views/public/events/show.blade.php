        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center text-sm text-brandGray-500 mb-4">
                    <a href="{{ route('public.events.index', app()->getLocale()) }}" class="hover:text-brandBlue-600">
                        {{ __('public.Events') }}
                    </a>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-brandGray-50 rounded-lg p-6">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex items-center">
                                <svg class="w-4 h-4 mr-2 text-brandBlue-600" fill="currentColor" viewBox="0 0 20 20">
