...
@section('title', 'Quran Lessons')
@section('page-title', 'Quran Lessons')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                @if($quranSubjects->count() > 0)
                    <div class="row">
                        @foreach($quranSubjects as $subject)
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted">
                            @if(app()->getLocale() === 'ar')
                                لا توجد دروس قرآن متاحة
                            @elseif(app()->getLocale() === 'dv')
                                ޤުރުއާން ދަރުސް ނެތް
                            @else
                                No Quran lessons available
                            @endif
                        </h5>
                    </div>
                @endif
