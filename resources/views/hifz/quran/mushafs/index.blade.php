...
<div class="flex justify-between mb-6"><h1 class="text-2xl font-bold">Quran Mushafs</h1>@can('manage', App\Domains\Hifz\Models\QuranMushaf::class)<a href="{{ route('hifz.quran.mushafs.create') }}" class="btn btn-primary">Upload Mushaf</a>@endcan</div>
