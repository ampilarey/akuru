...
Captured from `main` at `3db7a08` (merge of PR #93, after #86–#92) when `STATUS.md` was rewritten as a code/tested/usable table. The original audit commit archived `c21630a`; this file was expanded at rebase so Round-2 fix records and Round 3 notes are not dropped.

The remainder is the previous append-log STATUS, verbatim.
