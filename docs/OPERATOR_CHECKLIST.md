...
**Do this before anything below.** Twenty-eight scripted walks drive real browsers
...
**Twenty-four of the twenty-eight write data** — they submit absence notes, request
...
twenty-four that change data. The `exams` walk needs a queue worker on the host
