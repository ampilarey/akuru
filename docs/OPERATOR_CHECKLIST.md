...
**Do this before anything below.** Twenty-nine scripted walks drive real browsers
...
**Twenty-five of the twenty-nine write data** — they submit absence notes, request
...
twenty-five that change data. The `exams` walk needs a queue worker on the host
