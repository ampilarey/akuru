...
**Do this before anything below.** Thirty-one scripted walks drive real browsers
...
**Twenty-seven of the thirty-one write data** — they submit absence notes, request
...
twenty-seven that change data. The `exams` walk needs a queue worker on the host
