...
**Do this before anything below.** Twenty-six scripted walks drive real browsers
...
**Twenty-two of the twenty-six write data** — they submit absence notes, request
...
twenty-two that change data. The `exams` walk needs a queue worker on the host
