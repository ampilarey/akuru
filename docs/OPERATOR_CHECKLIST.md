...
**Do this before anything below.** Twenty-four scripted walks drive real browsers
...
**Twenty of the twenty-four write data** — they submit absence notes, request
...
twenty that change data. The `exams` walk needs a queue worker on the host
