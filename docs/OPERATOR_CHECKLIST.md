...
**Do this before anything below.** Thirty scripted walks drive real browsers
...
**Twenty-six of the thirty write data** — they submit absence notes, request
...
twenty-six that change data. The `exams` walk needs a queue worker on the host
