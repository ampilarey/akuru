...
**Do this before anything below.** Twenty-three scripted walks drive real browsers
...
**Nineteen of the twenty-three write data** — they submit absence notes, request
...
nineteen that change data. The `exams` walk needs a queue worker on the host
