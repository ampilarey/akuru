...
**Do this before anything below.** Twenty-five scripted walks drive real browsers
...
**Twenty-one of the twenty-five write data** — they submit absence notes, request
...
twenty-one that change data. The `exams` walk needs a queue worker on the host
