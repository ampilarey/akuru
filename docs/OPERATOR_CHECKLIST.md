...
**Do this before anything below.** Thirty-four scripted walks drive real browsers
...
**Thirty of the thirty-four write data** — they submit absence notes, request
...
thirty that change data. The `exams` walk needs a queue worker on the host
