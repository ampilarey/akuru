...
**Do this before anything below.** Twenty-seven scripted walks drive real browsers
...
**Twenty-three of the twenty-seven write data** — they submit absence notes, request
...
twenty-three that change data. The `exams` walk needs a queue worker on the host
