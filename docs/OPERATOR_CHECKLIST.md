...
**Do this before anything below.** Twenty-two scripted walks drive real browsers
...
**Eighteen of the twenty-two write data** — they submit absence notes, request
...
eighteen that change data. The `exams` walk needs a queue worker on the host
