...
| 3 C2 completion + performance reports | Yes. Staff `/catalog/reports/completions`; portal `/portal/performance`. | `CourseCompletionReportTest`. | Walked this PR. | Offering + course summaries, roster CSV; parent/student rows via People actions only. |
