...
| W1.2 trust above the fold | Yes. Settings group `trust_settings`; homepage hero accreditation / years / students / partner logos. Years from founded year or override; students manual or unified `students` count. Logos via Media public files. | `HomepageTrustTest`; `PublicMediaTest`. | This PR (browser walk). | Empty settings omit the signal (no invented 500+ / 5+). No admin form yet. About page still hardcodes Est. 2020 and `years=5`. |
