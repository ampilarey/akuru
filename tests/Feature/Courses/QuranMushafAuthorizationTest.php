...
class QuranMushafAuthorizationTest extends TestCase
{
    ...
    public function test_dean_can_lock_mushaf(): void
    {
        ...
        $this->actingAs($dean)->post(route('quran.mushafs.lock', $mushaf));
    ...
    public function test_teacher_cannot_lock_mushaf(): void
    {
        ...
        $this->actingAs($teacher)->post(route('quran.mushafs.lock', $mushaf));

        $response = $this->actingAs($teacher)->post(route('quran.mushafs.lock', $mushaf));
