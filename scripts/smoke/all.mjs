 ...
 *
 * Four of these only look at screens. The other **twenty-two write**: they build a course for a student, run a scheduled intake, set and sit an assessment, issue a certificate, sell a course for wallet money, tag an Arabic skill activity, enrol a
 ...
 *   node scripts/smoke/all.mjs --write    the twenty-two that change data
