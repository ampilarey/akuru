...
# The student-unification gate (S2.0) ran here until S1 Deploy 3 archived
# `registration_students` and retired `students:verify-unification` with it
# (STATUS §5gh). There is nothing left for it to verify.
